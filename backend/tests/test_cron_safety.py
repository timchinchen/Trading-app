...
def test_safe_cron_step_minutes_accepts_valid_range():
...
def test_safe_cron_step_minutes_falls_back_on_invalid_values():
    ...
    assert _safe_cron_step_minutes(90) == _DEFAULT_AGENT_CRON_MINUTES
    assert _safe_cron_step_minutes("oops") == _DEFAULT_AGENT_CRON_MINUTES


def test_safe_agent_cron_minutes_accepts_valid_range():
...
def test_safe_agent_cron_minutes_falls_back_on_invalid_values():
    ...
    assert _safe_agent_cron_minutes(90, source="test") == _AGENT_CRON_MINUTES_DEFAULT
